...
class NavMeshPrefabInstanceEditor : Editor
{
    ...
    SerializedProperty m_AgentIndex;
    SerializedProperty m_IncludedLayerMask;
    ...
    public void OnEnable()
    {
        ...
        m_AgentIndex = serializedObject.FindProperty("m_AgentIndex");
        m_IncludedLayerMask = serializedObject.FindProperty("m_IncludedLayerMask");
    }
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(m_AgentIndex);
        EditorGUILayout.PropertyField(m_IncludedLayerMask);
    ...
    NavMeshData Build(NavMeshPrefabInstance instance)
    {
        ...
        NavMeshBuilder.CollectSources(root, m_IncludedLayerMask.intValue, NavMeshCollectGeometry.RenderMeshes, 0, markups, sources);
        var settings = NavMesh.GetSettingsByIndex(m_AgentIndex.intValue);
