...
public class TempNonVR_ObjInfoWindow : MonoBehaviour
{
    ...
    private static TempNonVR_ObjInfoWindow _instance = null;

    public static TempNonVR_ObjInfoWindow Instance
    {
        get
        {
            if (!FindObjectOfType<TempNonVR_ObjInfoWindow>())
                _instance = ((GameObject)Instantiate(Resources.Load("TempNonVR_SceneObjInfoCanvas"))).GetComponent<TempNonVR_ObjInfoWindow>();
            return _instance;
        }
    }
